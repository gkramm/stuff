...
let g:syntastic_jutoson_checkers=['jsonlint']
...
map <leader>gP :Git pull origin master<CR>
map <leader>GP :Git pull kramg003 master<CR>
map <leader>gp :Git pull origin
map <leader>Gp :Git pull kramg003
map <leader>gU :Git push origin master<CR>
map <leader>GU :Git push kramg003 master<CR>
map <leader>gu :Git push origin
map <leader>Gu :Git push kramg003
map <leader>gb :Git branch<CR>
map <leader>gB :Git checkout
map <leader>gc :Git commit -m "
map <leader>gr :Gremove<CR>
map <leader>sv :so $MYVIMRC<CR>
map <leader>ct :! bash --login ~/cookbooktest.sh %:p:h<CR>
map <leader>cU :! bash --login ~/cookbookupload.sh %:p:h<CR>
map <leader>sh :shell
